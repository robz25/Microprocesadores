...
;
;       DESCRIPCION:    Imprimir volumen de tanque de 15 m leido con ADT0
;                       y activar o desactivar la bomba segun corresponda
;
;*******************************************************************************
...
CR:     EQU     $0A  ;carry return
LF:     EQU     $0D     ;line feed
SUB:    EQU     $1A     ;Borrado pantalla
P15:    EQU     14      ;nivel de 15 por ciento de volumen
P30:    EQU     31      ;nivel de 30 por ciento de volumen
P90:    EQU     98      ;nivel de 90 por ciento de volumen
P100:   EQU     106     ;nivel de 100 por ciento de volumen
...
COMPLETADO:     ds 1
;*******************************************************************************
;                            Relocalizacion vectores
;*******************************************************************************

         org        $FFD2  ;Flash para simulador
        dw ATD0_ISR
        
         org        $FFF0  ;Flash para simulador
        dw RTI_ISR
        
         org        $FFD4  ;Flash para simulador
        dw SCI_ISR
...
CALCULO: 	     	;                    Subrutina CALCULO
                        ;*******************************************************
                        ; Subrutina que se encarga de obtener el volumen basado
                        ; en la lectura de la altura promedio obtenida por el
                        ; sensor analogico.
                        ;*******************************************************
...
CONV_ASCII:     	;                    Subrutina CONV_ASCII
                        ;*******************************************************
                        ;Subrutina que se encargar de convertir los mensajes a
                        ; desplegar en ascii para poder ser transmitidos por
